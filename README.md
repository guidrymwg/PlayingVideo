...
This project assumes the Gradle build system in Android Studio. It was targeted at Android 6.0 (API 23) but should be compatible with API 15 and beyond.  You will need
 ...
 - A video file in appropriate format stored on the device. The file used in the example will be Bawwlllll.mp4, which may be obtained from http://eagle.phys.utk.edu/guidry/android/audio-video/, or you can substitute your own.
...
going to http://eagle.phys.utk.edu/guidry/android/ and selecting <em>Playing Video</em> from the menu.
